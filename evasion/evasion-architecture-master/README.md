...
The provided client `players/randomClient.py` is a random hunter/prey combination and you may change ```playHunter(self)``` and `playPrey(self)` functions to implement custom strategies. 
