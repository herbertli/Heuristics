...
class UTrenchManager(Player):
    def __init__(self, name):
        super(UTrenchManager, self).__init__(name=name, is_trench_manager=True)
        ...
        self.L = game_info['L']
        self.p = game_info['p']
        self.ut = Useless_Trench(self.d, self.y, self.r, self.m, self.L, self.p)
    ...
    def choose_alert(self, sent_probes, results):
        ...
        """
        self.ut.receiveProbeResults(results)
        return "red" if self.ut.shouldGoRed() else "yellow"
