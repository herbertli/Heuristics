...
def main():
    ...
    parser.add_argument(
        "--manual", help="Allows you to choose which player you'd like to play manually: 'sub', 'trench', or 'both'")
    ...
    player_1 = Process(target=init_submarine_captain, args=(
        'Captain Joe', is_submarine_manual, sys.stdin.fileno()))
    player_1.start()
    player_2 = Process(target=init_trench_manager, args=(
        'Manager Zach', is_trench_manual, sys.stdin.fileno()))
    player_2.start()
